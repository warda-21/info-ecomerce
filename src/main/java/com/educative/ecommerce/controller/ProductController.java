...
public class ProductController {
    ...
    public ResponseEntity<List<ProductDto>> getProductsFromCategory(@PathVariable("categoryId") Integer categoryId) {
        List<ProductDto> products = productService.getProductsFromCategory(categoryId);
        return new ResponseEntity<>(products, HttpStatus.OK);
    }
